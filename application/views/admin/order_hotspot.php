...
<div class="modal" id="modal_input_user" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-user pr-2"></i>Tambah User</h5>
            ...
            <div class="modal-body">
                <p class="mb-1">Name</p>
				<input type="text" id="name" class="form-control form-clear mb-2" placeholder="Masukkan Name Client">
                <p class="mb-1">Email</p>
                <input type="email" id="email" class="form-control form-clear mb-2" placeholder="Masukkan Email Client">
                <p class="mb-1">Phone Number / WA</p>
                <input type="number" id="phone_number" class="form-control form-clear mb-2" placeholder="Masukkan Telpon Client">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-simpan-user">Simpan</button>
