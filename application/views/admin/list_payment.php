...
<div class="container-fluid">
    ...
    <div class="w-100 text-right mb-2"><a href="<?=base_url("list_payment/form_payment/0")?>" class="btn btn-sm btn-info"><i class="fas fa-plus mr-2"></i>Create Payment</a></div>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-horvered w-100" id="datatable">
                            ...
                            <tbody>
                                <?php
                                $data = $this->model->gd("payment_method","*","id_mitra = '".$this->id_mitra."' AND id !=","result");
                                $load = '';
                                if(!empty($data)){
                                    $no = 1;
